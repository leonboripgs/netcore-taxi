...
namespace ApiInfraestructure.Services
{
    ...
    /// </summary>
    public class ViajeConductorService : IViajeConductorInfraestructureService
    {
        private readonly IViajeConductorRepository _repository;
        #region CONSTRUCTOR
        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="context">Contexto de base de datos</param>
        public ViajeConductorService(IViajeConductorRepository repository)
        {
